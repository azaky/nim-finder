...
## combine with others
browserify "$dist_dir"/material.min.js "$dist_dir"/chosen.jquery.min.js "$dist_dir"/jquery.twbsPagination.min.js "$dist_dir"/nim-finder.obfuscated.min.js "$dist_dir"/analytics.js -o "$dist_dir"/nim-finder.bundle.min.js
...
## combine with others
browserify "$dist_dir"/material.min.js "$dist_dir"/nim-finder-report.obfuscated.min.js "$dist_dir"/material.min.js -o "$dist_dir"/nim-finder-report.min.js
